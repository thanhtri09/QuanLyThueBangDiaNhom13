...
public class FrmDatTruoc extends JFrame implements ActionListener,MouseListener {
	...
	private JButton btnThoat,btnKhachHangTim,btnchonDia,btnTuaDeTim,btnXacNhanKhachHang,btnDoiKhachHang,btnDoiTieuDe,btnXacNhanTieuDe,btnMoThem,btnThemPhieuDatTruoc,btnXoa;
	...
	private void initialize() {
		...
		btnMoThem.setBounds(51, 217, 106, 38);
		panel.add(btnMoThem);
		
		btnXoa = new JButton("XÓA");
		btnXoa.setBounds(183, 217, 106, 38);
		panel.add(btnXoa);
		
		btnThemPhieuDatTruoc = new JButton("LẬP PHIẾU ĐẶT TRƯỚC");
		btnThemPhieuDatTruoc.setBounds(302, 217, 188, 38);
		...
		btnThoat.setBounds(522, 217, 106, 38);
		panel.add(btnThoat);
